                            ...
                            <div class="col-12">
                                <div class="card">                                    
                                    <div class="card-body">   
                                        ...
                                        <form action="{{ url('dashboard/update',$theme->id) }}" method="POST" enctype="multipart/form-data" id="update_entrant_form">
                                            @csrf
                                            <div class="col-6 mb-3">
                                                ...
                                                <select class="form-control" name="theme" id="theme_id">
                                                  ...
                                                  @if(!empty($theme->themeImage))
                                                    <div class="form-group">
                                                        <label class="form-label" for=""></label>
                                                        <div class="form-control-wrap">
                                                            <img class="" src="{{ url('storage/app/public',$theme->themeImage->image) }}" alt="" width="80" height="80">
                                                        </div>
                                                    </div>
                                                    @endif
                                                <div class="col-6 mb-3">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            ...
                                                            <textarea class="form-control" aria-label="With textarea" name="description">{{$theme->description}}</textarea>      
                                                    </div>
                                                    @error('description')
...
$("#theme_id option[value='{{$theme->theme}}']").prop('selected', true);
