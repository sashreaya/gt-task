...
<style type="text/css">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="text-sm-end">
                                                        <a href="<?php echo e(url('admin/export-user')); ?>"><button type="button" class="btn btn-success waves-effect waves-light mb-2"><i class="mdi mdi-plus me-1"></i>Export Best Shot</button></a>
                                                    </div>
                                                </div><!-- end col-->
                                            </div>
    ...
    <script type="text/javascript">
       ...
       $(function dataTable(){
        ...
        var table = $("#myTable").dataTable({
            ...
            "serverSide": true,
            ajax:"<?php echo e(url('admin/index')); ?>",
            "order":[
            [0,"asc"]
            ],
            "columns":[
   ...
   function dataTableShot(id){
            ...
            oLanguage: {sProcessing: "<div id='datatable-loader'></div>"},
            "serverSide": true,
            ajax:"<?php echo e(url('admin/getShots')); ?>?&id="+id,
            "order":[
            [0,"asc"]
            ],
            "columns":[           
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\gt-task\resources\views/admin/index.blade.php ENDPATH**/ ?>